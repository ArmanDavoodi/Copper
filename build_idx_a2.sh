...
for ((i=0; i<$VAR_NUM_COMMANDS; i++)); do
    ...
    VAR_LEAF_CLUSTER_CAP=${VAR_LEAF_CLUSTER_CAP_LISTS[i]}
    VAR_INTERNAL_CLUSTER_CAP=${VAR_INTERNAL_CLUSTER_CAP_LISTS[i]}
    echo ============================================================================================================================================================================================================================================================================================================ >> $ROOT/a2128_clustering_tree_sen.log
    echo "building ivf-tree with leaf_cluster_cap=$VAR_LEAF_CLUSTER_CAP, internal_cluster_cap=$VAR_INTERNAL_CLUSTER_CAP, output_file=$VAR_OUTPUT_FILE_NAME"
    echo "building ivf-tree with leaf_cluster_cap=$VAR_LEAF_CLUSTER_CAP, internal_cluster_cap=$VAR_INTERNAL_CLUSTER_CAP, output_file=$VAR_OUTPUT_FILE_NAME" >> $ROOT/a2128_clustering_tree_sen.log
    ./bench/datasets/bin/clustering $VAR_INPUT_FILE $VAR_OUTPUT_FILE_DIR/$VAR_OUTPUT_FILE_NAME 120 134217728 24 kmeans_hierarchical $VAR_LEAF_CLUSTER_CAP $VAR_INTERNAL_CLUSTER_CAP 0 max 512 >> $ROOT/a2128_clustering_tree_sen.log 2>&1
    echo "done building ivf-tree with leaf_cluster_cap=$VAR_LEAF_CLUSTER_CAP, internal_cluster_cap=$VAR_INTERNAL_CLUSTER_CAP, output_file=$VAR_OUTPUT_FILE_NAME"
    echo "done building ivf-tree with leaf_cluster_cap=$VAR_LEAF_CLUSTER_CAP, internal_cluster_cap=$VAR_INTERNAL_CLUSTER_CAP, output_file=$VAR_OUTPUT_FILE_NAME" >> $ROOT/a2128_clustering_tree_sen.log
    echo ============================================================================================================================================================================================================================================================================================================ >> $ROOT/a2128_clustering_tree_sen.log
done
