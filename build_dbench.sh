...
rm disaggregated_bench/memory_node/run.conf
rm disaggregated_bench/compute_node/run.conf
source disaggregated_bench/ivfflat_build_configs.sh

make clean -C disaggregated_bench
...
VAR_LOG_TAG_HANG_DETECTOR_NUM=$(( 2#10000000000 ))
VAR_LOG_TAG_RDMA=OFF
VAR_LOG_TAG_RDMA_NUM=$(( 2#100000000000 ))
...
make -C disaggregated_bench DEFINES="$FLAGS"
cd $CURDIR