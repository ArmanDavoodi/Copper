...
inline std::pair<String, String> ReadNetworkConfigs() {
    fprintf(stderr, "Reading network configuration from file: %s\n", network_config::network_config_file_path);
    ...
    config_file.close();
    return {memory_node_list, compute_node_list};
}
